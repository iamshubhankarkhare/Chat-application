...
const Input = ({ setMessage, sendMessage, message, handleEmoji, setIsEmoji, setMsg, handleKeydown, isEmoji, addEmoji, setimg }) => {
    ...
    <div>
      ...
      <form className="form">
        ...
        <button className="sendButton" onClick={(e) => sendMessage(e)}>
            <svg stroke="white" fill="green" strokeWidth="0" t="1569683742680" viewBox="0 0 1024 1024" version="1.1" height="45px" width="45px" xmlns="http://www.w3.org/2000/svg"><defs></defs>
