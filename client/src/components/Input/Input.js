    ...
    <div>
      ...
      <form className="form">
        ...
        <button className="sendButton" onClick={e => sendMessage(e)}>
            <svg stroke="white" fill="green" stroke-width="0" t="1569683742680" viewBox="0 0 1024 1024" version="1.1" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg"><defs></defs>
